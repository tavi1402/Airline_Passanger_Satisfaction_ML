...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # print(f"Best Model Found, Model Name is: {best_model_name},Roc AUC: {best_model_score}")
            # print("\n***************************************************************************************\n")
            # logging.info(f"Best Model Found, Model Name is: {best_model_name},Roc AUC: {best_model_score}")
            ...
            # return r2_score_ ,accuracy_score_, classification_report_
